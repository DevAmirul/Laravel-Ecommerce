            ...
            <div class="card my-4">
                <div class=" card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class=" bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Edit Coupon table</h6>
                    </div>
                </div>
                <div class="col-6 m-auto mt-5 ">
                    <form wire:submit.prevent='updateCoupon' class="row g-3 shadow-lg rounded-3"
                        ...
                        <div class="form-floating col-md-12 shadow-lg">
                            <input wire:model.defer='expiryDate' type="text" class="form-control" id="date-pick" placeholder="Date">
